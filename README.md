...
Apple MLX framework'ü üzerinde eğitilen 3-katmanlı MLP (Multi-Layer Perceptron):
...
### Test Metrikleri (v0.1 — MLX MLP, 68 epoch)
...
# 6. Özellik ihracı ve MLX eğitimi
...
│   ├── train_scoring_mlx.py       # MLX MLP eğitim betiği
...
│   └── ablation_generated_mlx/              # MLX ablation deneyleri
│
├── tests/                         # Birim ve entegrasyon testleri
├── examples/                      # Örnek kullanım betiği
├── mlx/                           # MLX ortam gereksinimleri
